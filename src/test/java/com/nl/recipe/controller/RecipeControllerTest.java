...
public class RecipeControllerTest {
    ...
    public void addRecipe(){
        ...
        assertThat(recipeResponseEntity.getBody().getRecipeName()).isEqualTo("Banana Bread");
    ...
    public void searchRecipesByIngredients() {
        ...
        List<Recipe> recipeList = Arrays.asList(getSavedRecipe());
        when(recipesService.searchRecipesByIngredients(recipesFilterRequest)).thenReturn(recipeList);
        ResponseEntity<List<Recipe>> recipeResponseEntity = recipesController.searchRecipesByIngredients(recipesFilterRequest);
        assertThat(recipeResponseEntity.getBody()).hasSize(1);
        assertThat(recipeResponseEntity.getBody().get(0).getRecipeName()).isEqualTo("Banana Bread");
    }
}
