...
public class RecipeService {
    ...
    public Recipe updateRecipeById(Recipe recipeToBeUpdated) {
        ...
        recipe.setServings(Optional.ofNullable(recipeToBeUpdated.getServings()).orElse(recipe.getServings()));
        return recipeRepository.save(recipe);
    }
     ...
     * @return
     */
    public List<Recipe> searchRecipesByIngredients(RecipesFilterRequest request) {
